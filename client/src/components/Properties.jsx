        ...
        <div>
          <div className="relative h-[45vh] md:h-[55vh] lg:h-[60vh]">
            ...
            <div className="absolute flex w-full h-full backdrop-opacity-10 backdrop-invert bg-transparent bg-gradient-to-b from-transparent to-black/90 h-full rounded-b-3xl items-center text-center">
              ...
              {showFilters && (
                <div className="absolute border border-gray-300 shadow-card rounded-3xl -bottom-[15rem] right-[8vw] p-2 z-40 w-1/2 h-auto bg-white text-black md:-bottom-52 md:w-52 xl:-bottom-44 xl:right-[13vw]">
                  <form>
                          ...
                          <div>
                            ...
                            <div className="mt-2">
                              <input
                                ...
                                //onChange={handleChangeEmail}
                                required
                                className="w-full py-[0.5rem] border border-gray-300 rounded-full font-dmSans text-gray-600 mb-4 shadow-button focus:ring-0 focus:border-primary"
                              />
                            </div>
                            <p className="font-dmSans text-gray-800">
                              Environments
                            ...
                            <button className="bg-primary w-full rounded-full mt-3 font-dmSans py-1 text-white hover:bg-primaryHover">
                              Filter
                            </button>
                          </div>
                        </div>
