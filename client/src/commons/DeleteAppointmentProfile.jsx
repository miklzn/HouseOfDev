const DeleteAppointmentProfile = ({ handleDeleteAppointment, closeModal }) => {
  return (
    <div
        ...
        <div className="">
          <div className="text-center p-5 justify-center min-[480px]:flex min-[480px]:items-center min-[480px]:space-x-4 min-[480px]:my-2">
            ...
            <h2 className="font-semibold font-dmSans">
              Would you like to cancel your appointment? This action cannot be
              undone.
            </h2>
          </div>
...
export default DeleteAppointmentProfile;
